...
export function AuroraBackgroundDemo() {
    return (
        <AuroraBackground>
            ...
            >
                <div className="my-1 text-[3.5rem] sm:text-7xl md:text-8xl lg:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-white ">elmajala-NFT</div>
                <div className="text-[0.8rem] sm:text-[1rem] md:text-[1.4rem] lg:text-3xl font-bold dark:text-white text-center">
                ...
                <div className="font-extralight text-xs sm:text-sm md:text-md text-justify dark:text-neutral-200 py-2 max-w-sm sm:max-w-xl">
